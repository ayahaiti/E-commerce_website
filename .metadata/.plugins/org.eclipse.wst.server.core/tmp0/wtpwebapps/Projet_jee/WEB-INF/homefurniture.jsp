...
<body>
	...
	<div class="topnav">
		<ul>
			<li><a href="accueil?goTo=getproducts">All Products</a></li>
			<li><a class="active" href="accueil?goTo=homefurniture">Home
					Furniture</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<c:forEach items="${list }" var="product">
					<c:if test="${product.getCategory() == 'homefurniture' }">
						<div class="col-md-3">
							...
							<div class="text-center">
								<a class="btn btn-success" href="accueil?goTo=checkProduct&id=<c:out value="${product.getId()}"/>">View
									Product</a> <br /> <br /> <a class="btn btn-success"
									href="accueil?goTo=homefurniture&add=addtopanier">Add to
									Basket</a>
							</div>
							<br>
						</div>
