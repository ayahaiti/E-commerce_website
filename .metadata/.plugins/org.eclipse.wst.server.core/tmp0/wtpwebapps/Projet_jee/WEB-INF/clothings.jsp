...
<body>
	...
	<div class="topnav">
		<ul>
			...
			<li><a class="active" href="accueil?goTo=clothings">Clothings</a></li>
	...
	<div class="pagewhole-content">
		<div class="container">
			...
			<c:forEach items="${list }" var="product">
				<c:if test="${product.getCategory() == 'clothings' }">
					<div class="col-xs-3">
						<img src="${product.getImage() }" class="img-responsive" /><br>
						<div class="text-center">
							<a style="color: black;" />
							<c:out value="${product.getTitre() }"></c:out>
							</a>
						</div>
						...
						<div class="text-center">
							<a class="btn btn-success"
								...
								href="accueil?goTo=clothings&add=addtopanier">Add to Basket</a>
						</div>
							<br>
						</div>
					</c:if>
