...
<body>
	...
	<ul>
		...
		<li><a class="haut" href="accueil?goTo=showcart">panier(<c:out
					value="${x}" />)
		</a></li>
	</ul>
	</nav> </header>
	<div class="topnav">
		<ul>
			...
			<li><a class="active" href="accueil?goTo=garden">Garden</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<c:forEach items="${list }" var="product">
					<c:if test="${product.getCategory() == 'garden' }">
						<div class="col-md-3">
							...
							<div class="text-center">
								<a class="btn btn-success"
									...
									href="accueil?goTo=garden&add=addtopanier">Add
									to Basket</a>
							</div>
							<br>
						</div>
